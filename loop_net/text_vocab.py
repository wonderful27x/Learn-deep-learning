...
# 这里得到的corpus是文本中每个字符的索引,形成一个一维列表
corpus, vocab = load_corpus_time_machine(type='word')
print(len(corpus))
print(len(vocab))
...
print('随机采样')
# 批量大小2，时间步5, 可以生成(35-1)/5 = 6个特征-标签对，得到3个小批量
my_seq = list(range(35))
# print('my_seq: ', my_seq)
# corpus, vocab = load_corpus_time_machine(type='word')
# print('corpus: ', corpus[:35])
...
data_iter, vocab = load_data_time_machine(batch_size=10, num_steps=5,
                                          use_random_iter=False, type='word')
